        ...
        while True:
            if zaehler == 0:
                ...
                while True:
                    ...
                    entfernung = ultraschallsensor.real_second_distance(first_time) #messe entfernung, wird ueberprueft ob richtig
            ...
            if entfernung > fillUp:
                ...
                if zaehler == 1:
                    ...
                    first_time = time.time() #Startzeit um Messfehler zu verringern, Liste Messungen möglich machen
                elif zustand:
